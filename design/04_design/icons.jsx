...
function Icon({ name, size = 20, style }) {
  ...
  switch (name) {
    ...
    case "candles":
      return <svg {...p}><path d="M7 3v4M7 17v4M17 3v2M17 14v7" /><rect x="4.5" y="7" width="5" height="10" rx="1" /><rect x="14.5" y="5" width="5" height="9" rx="1" /></svg>;
    case "line":
      return <svg {...p}><path d="M3 17l5-6 4 3 8-9" /></svg>;
    case "sun":
    ...
    case "docs":
      return <svg {...p}><path d="M4 4a2 2 0 0 1 2-2h9l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4Z" /><path d="M14 2v5h5" /><path d="M8 12h8M8 16h6" /></svg>;
    case "copy":
      return <svg {...p}><rect x="9" y="9" width="11" height="11" rx="2" /><path d="M5 15V5a2 2 0 0 1 2-2h8" /></svg>;
    case "play":
      return <svg {...p}><path d="M7 4v16l13-8L7 4Z" /></svg>;
    case "menu":
...
// ============================================================
// ARGOS — 3D dönen küp logosu (Cursor küp animasyonu hissi)
// Her yüzünde "göz" halkası: 100 gözlü Argos teması.
// CSS: styles.css → .argos-cube*
// ============================================================
function ArgosCube({ size = 32, spin = true, className = "" }) {
  const s = size + "px";
  return (
    <span className={"argos-cube-wrap " + className} style={{ width: s, height: s }}>
      <span className={"argos-cube" + (spin ? " spin" : "")} style={{ width: s, height: s, "--cs": s }}>
        <span className="argos-cube__face f-front" />
        <span className="argos-cube__face f-back" />
        <span className="argos-cube__face f-right" />
        <span className="argos-cube__face f-left" />
        <span className="argos-cube__face f-top" />
        <span className="argos-cube__face f-bottom" />
      </span>
    </span>
  );
}

window.ArgosCube = ArgosCube;
