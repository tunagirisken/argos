...
> Profesyonel portföy yönetim uygulaması · Bloomberg Terminal + modern fintech hissi
...
:root {
  /* Yüzeyler */
  --bg-base:      #080810;   /* en koyu, ana arkaplan */
  --bg-surface:   #0f0f1a;   /* kart arkaplanı */
  --bg-elevated:  #161625;   /* hover/active kartlar */
  --bg-overlay:   #1d1d30;   /* modal, dropdown, tooltip */
  --border-subtle:  #1e1e35; /* ince border */
  --border-default: #2a2a45; /* normal border */

  /* Accent (Argos Mavi-Mor) */
  --accent-primary: #7c6cf8;
  --accent-hover:   #6d5de8;
  --accent-glow:    rgba(124,108,248,0.15);

  /* Durum */
  --positive:     #00d084;   --positive-dim: rgba(0,208,132,0.15);
  --negative:     #ff4d6a;   --negative-dim: rgba(255,77,106,0.15);
  --warning:      #ffb547;   --warning-dim:  rgba(255,181,71,0.15);
  --info:         #40c8ff;
...
- Grafikler: lightweight-charts (candlestick) VEYA recharts (area/composed)
