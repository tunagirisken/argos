...
function App() {
  ...
  let screen;
  if (base === "dashboard") screen = <Dashboard onOpen={openStock} />;
  else if (base === "stock") screen = <StockDetail ticker={route.split(":")[1]} onOpen={openStock} onBack={() => setRoute("dashboard")} />;
  ...
  else screen = <Dashboard onOpen={openStock} />;
    ...
    <div className="app">
      ...
      <TweaksPanel>
        ...
        <TweakColor label="Aksan rengi" value={t.accent}
          options={["#7c6cf8", "#40c8ff", "#00d084", "#ff7eb6", "#ffb547"]}
        ...
        <TweakSlider label="Köşe yuvarlaklığı" value={t.radius} min={4} max={24} unit="px"
